...
public class FBBulletType3 : MonoBehaviour
{
    ...
    public void SetValue(float posX, float speed, float damage, bool fakeBullet, bool isHitBackBullet)
    {
        this.speed = speed;
        this.damage = damage;
        ...
        if(fakeBullet)
        {
            target = new Vector2(posX, -Camera.main.orthographicSize/4f);
        }
        else{
